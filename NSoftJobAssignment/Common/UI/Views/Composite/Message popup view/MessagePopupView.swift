...
open class MessagePopupView: UIView {
  ...
  private(set) lazy var actionButton = ActionButton.close(target: self, selector: #selector(actionButtonTapped))
...
private extension MessagePopupView {
  ...
  func setupView() {
    ...
    layer.borderWidth = 4
    layer.borderColor = ColorAssets.General.pokeRed.color.cgColor
  ...
  func setupSubtitleLabel() {
    ...
    subtitleLabel.textColor = ColorAssets.General.pokeLightGray.color
  }
